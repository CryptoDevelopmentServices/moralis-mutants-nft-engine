...
const masterKey = "xxxx"; // DO NOT DISPLAY IN PUBLIC DIR
const xAPIKey = "xxxx"; // DO NOT DISPLAY IN PUBLIC DIR
...
const startCreating = async () => {
  ...
  while (editionCount <= editionSize) {
    ...
    const saveFile = async () => {
      ...
      console.log(
        "Welcome to Rekt City - Meet the Survivors " + editionCount.toString() 
      );
  ...
  console.log("###############################");
  console.log("Welcome to CryptoDeveloperPunks");
  console.log("###############################");
  console.log();
};
